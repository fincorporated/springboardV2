        ...
        <div id="faqBackground" className="background">
            <div id="faq" className="page">
                ...
                <div onClick={() => expandAnswer('answerB')} className="question">
                    ...
                    <p id='answerB' className="questionAnswer"><span>Here’s what we cover:</span>  <br/> - Tuition for all students including workshops, show tickets, transportation within the city, and materials. <br/> - Housing for students and guardians coming from outside the NYC area. <br/> - One meal a day during program hours. <br/> <span>Here’s what SB2D students are responsible for:</span> <br/> - Transportation to and from the program. <br/> - “On your own” meals, noted on the program schedule.</p>
                </div>
